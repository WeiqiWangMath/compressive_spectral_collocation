...
legend([hmean_plot vert_plot],{'CS','QCBP','Backslash','$$\sigma_s(c_\Lambda)_1/\sqrt{s}$$','$$s=|\Lambda|$$'},'Interpreter','latex')
set(gca,'YScale','log')
xlabel('s=m/2')
...
save('data/D2_EtaSparse_SoluNonSparse.mat','s_vals','y_data','N');
